...
** Requirements
   ...
   input. Tincture's components are built using [[https://github.com/reagent-project/reagent][Reagent]] APIs, so
   Reagent is required as well.
...
**** :tincture/breakpoint-up
     ...
     960 :lg 1280 :xl 1920}~
** Disclaimer
   Tincture is not a UI framework, it's simply various functions and
   components I use on a regular basis being a frontend developer
   using ClojureScript. Many components in Tincture is based on
   [[https://material-ui.com/][Material UI]], and is simply an adaptation of those componets in
   ClojureScript. If you want a framework I wholeheartedly recommend
