...
(def ^{:deprecated "0.3.0"} mail Mail)
(def ^{:deprecated "0.3.0"} instagram Instagram)
(def ^{:deprecated "0.3.0"} facebook Facebook)
(def ^{:deprecated "0.3.0"} twitter Twitter)
(def ^{:deprecated "0.3.0"} bars Bars)
(def ^{:deprecated "0.3.0"} chevron-right ChevronRight)
(def ^{:deprecated "0.3.0"} chevron-left ChevronLeft)
(def ^{:deprecated "0.3.0"} chevron-down ChevronDown)
(def ^{:deprecated "0.3.0"} chevron-up ChevronUp)
(def ^{:deprecated "0.3.0"} menu Menu)
